...
<html>
  <head>
    ...
    <title>My JSP 'userSingleDepartmentDutyDepartment.jsp' starting page</title>
  </head>
  
  <body>
    <html:form action="allSingleDepartmentEmployeeDepartment">
  <%
  ...
  <center>
   	...
   	<logic:iterate id="aDutyDepartmentlist" name="getDutyDepartmentList">
   		...
   		<td><a href="amendDepartmentDuty.do?method=amend&id=<bean:write name="aDutyDepartmentlist" property="user_id"/>&dept_id=<bean:write name="aDutyDepartmentlist" property="department_id"/>"><bean:message key="user.amend"/></a></td>
   		</tr>
   	</logic:iterate>
   	</table>
   	</center>
