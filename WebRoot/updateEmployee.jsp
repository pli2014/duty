...
<html>
  ...
  <body>
     <html:form action="getUpdateEmployee">
    	<table border="1">
    	<tr><td>修改页面</td></tr>
    	<tr>
    	...
    	<tr>	
			...
			<html:text property="user_name"></html:text></td>
		</tr>
		...
		<tr>
    		<td>部门
    			...
    			%>
    				...
    				<%
    					if(user.getDepartment_id().equals(dp.getDepartment_id()))out.print("selected"); %>>
		...
		<tr>
    		<td>角色
    			...
    			%>
    				...
    				<%
    					if(user.getRole_id().equals(re.getRole_id()))out.print("selected"); %>>
