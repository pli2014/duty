...
public class getDepartmentDutyAction extends DispatchAction 
{
	public  ActionForward amend(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		System.out.println("\n");
		System.out.println("------getDepartmentDutyAction----");
		...
		ActionForward forward = mapping.findForward("updateDepartmentDutyUser");
		return forward;
	}
